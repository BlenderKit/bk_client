...
// Handles Code Verifier and State parameters exchange for OAuth2 verification.
// Add-on creates PKCE pair (Code Challenge + Code Verifier) and sends its code_verifier to Client so it can later verify the response from server.
